...
public class DogePhotoManipulatorTest {
	...
	private PhotoManipulator manipulator = new DogePhotoManipulator((text) -> {
		text.add("very1", "so1", "what1");
		text.add("very2", "so2", "what2");
	});
	...
	public void clean() {
		...
		this.file = new File(target, "manipulatedhoff.png");
		this.file.delete();
